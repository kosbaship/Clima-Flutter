...
class WeatherModel {
  ...
  Future<dynamic> getWeatherDataWithCityName( String ctyName) async{
    NetworkHelper networkHelper = NetworkHelper('$openWeatherMapURL?q=$ctyName&appid=$apiKey&units=metric');
